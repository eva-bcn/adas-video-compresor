...
**[⬇️ Descargar última versión](https://github.com/eva-bcn/adas-video-compresor/releases/latest)**
...
1. Descarga `avi2mp4.zip` desde [Releases](https://github.com/eva-bcn/adas-video-compresor/releases/latest)
